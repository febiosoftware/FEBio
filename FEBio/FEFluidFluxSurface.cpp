...
void FEFluidFluxSurface::FluxStiffness(FESurfaceElement& el, matrix& ke, vector<double>& wn, double dt, bool mixture)
{
	int i, j, n;
...
bool FEFluidFluxSurface::FlowRate(FESurfaceElement& el, vector<double>& fe, vector<double>& wn, double dt, bool mixture)
{
	int i, n;
...
bool FEFluidFluxSurface::LinearFlowRate(FESurfaceElement& el, vector<double>& fe, vector<double>& wn, double dt, bool mixture)
{
	int i, n;
...
void FEFluidFluxSurface::Serialize(FEM& fem, DumpFile& ar)
{
	if (ar.IsSaving())
	{
		size_t i;
...
void FEFluidFluxSurface::StiffnessMatrix(FESolidSolver* psolver)
{
...
void FEFluidFluxSurface::Residual(FESolidSolver* psolver, vector<double>& R)
{
	FEM& fem = psolver->m_fem;
	double dt = fem.m_pStep->m_dt;
