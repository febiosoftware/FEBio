...
void FETransIsoMooneyRivlin::Tangent(double D[6][6], FEMaterialPoint& mp)
{
	...
	// TODO: we already calculated this when we update the stress
	a.x = F[0][0]*a0.x + F[0][1]*a0.y + F[0][2]*a0.z;
	a.y = F[1][0]*a0.x + F[1][1]*a0.y + F[1][2]*a0.z;
	a.z = F[2][0]*a0.x + F[2][1]*a0.y + F[2][2]*a0.z;
...
*/
	...
	D[0][1] -= (4.0/3.0)*Ji*(W2*(I1*B[0][0] - B2[0][0]) + W44*I4*I4*a.x*a.x);
	D[0][1] -= (4.0/3.0)*Ji*(W2*(I1*B[1][1] - B2[1][1]) + W44*I4*I4*a.y*a.y);
	...
	D[1][2] -= (4.0/3.0)*Ji*(W2*(I1*B[1][1] - B2[1][1]) + W44*I4*I4*a.y*a.y);
	D[1][2] -= (4.0/3.0)*Ji*(W2*(I1*B[2][2] - B2[2][2]) + W44*I4*I4*a.z*a.z);
	...
	D[0][2] -= (4.0/3.0)*Ji*(W2*(I1*B[0][0] - B2[0][0]) + W44*I4*I4*a.x*a.x);
	D[0][2] -= (4.0/3.0)*Ji*(W2*(I1*B[2][2] - B2[2][2]) + W44*I4*I4*a.z*a.z);
