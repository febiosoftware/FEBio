...
//	B2[2][1] = B[2][0]*B[0][1]+B[2][1]*B[1][1]+B[2][2]*B[2][1];
	...
	T[0][0] = w1pw2i1*B[0][0] - W2*B2[0][0] + W4a*I4a*a.x*a.x + W4b*I4b*b.x*b.x + W4c*I4c*c.x*c.x;
	T[0][1] = w1pw2i1*B[0][1] - W2*B2[0][1] + W4a*I4a*a.x*a.y + W4b*I4b*b.x*b.y + W4c*I4c*c.x*c.y;
	T[0][2] = w1pw2i1*B[0][2] - W2*B2[0][2] + W4a*I4a*a.x*a.z + W4b*I4b*b.x*b.z + W4c*I4c*c.x*c.z;

//	T[1][0] = w1pw2i1*B[1][0] - W2*B2[1][0] + W4a*I4a*a.y*a.x + W4b*I4b*b.y*b.x + W4c*I4c*c.y*c.x;
	T[1][1] = w1pw2i1*B[1][1] - W2*B2[1][1] + W4a*I4a*a.y*a.y + W4b*I4b*b.y*b.y + W4c*I4c*c.y*c.y;
	T[1][2] = w1pw2i1*B[1][2] - W2*B2[1][2] + W4a*I4a*a.y*a.z + W4b*I4b*b.y*b.z + W4c*I4c*c.y*c.z;

//	T[2][0] = w1pw2i1*B[2][0] - W2*B2[2][0] + W4a*I4a*a.z*a.x + W4b*I4b*b.z*b.x + W4c*I4c*c.z*c.x;
//	T[2][1] = w1pw2i1*B[2][1] - W2*B2[2][1] + W4a*I4a*a.z*a.y + W4b*I4b*b.z*b.y + W4c*I4c*c.z*c.y;
	T[2][2] = w1pw2i1*B[2][2] - W2*B2[2][2] + W4a*I4a*a.z*a.z + W4b*I4b*b.z*b.z + W4c*I4c*c.z*c.z;
