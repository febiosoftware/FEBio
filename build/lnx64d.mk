...
DEF = -DLINUX -DPARDISO -DSUPERLU -DHAVE_LEVMAR -DHAVE_ZLIB -DHAVE_GSL
...
LIBS = -L$(FEBDIR)/build/lib $(LEV_LIB) $(SUPERLU_LIB) $(MKL_LIB) $(GSL_LIB)

INC = -I$(INTEL_INC) -I$(FEBDIR) -I$(FEBDIR)build/include -I$(SUPERLU_INC)
