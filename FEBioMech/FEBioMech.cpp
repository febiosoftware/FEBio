...
REGISTER_FECORE_CLASS(FEConstBodyForceOld   , FEBODYLOAD_ID, "const"    , 0x0205);	// obsolete in 3.0
...
REGISTER_FECORE_CLASS_OBSOLETE(FESlidingInterface         , FESURFACEPAIRINTERACTION_ID, "sliding_with_gaps"          , 0x0205);
REGISTER_FECORE_CLASS_OBSOLETE(FEFacet2FacetSliding       , FESURFACEPAIRINTERACTION_ID, "facet-to-facet sliding"     , 0x0205);
REGISTER_FECORE_CLASS_OBSOLETE(FESlidingInterfaceBW       , FESURFACEPAIRINTERACTION_ID, "sliding-tension-compression", 0x0205);
REGISTER_FECORE_CLASS_OBSOLETE(FETiedInterface            , FESURFACEPAIRINTERACTION_ID, "tied"                       , 0x0205);
REGISTER_FECORE_CLASS_OBSOLETE(FEFacet2FacetTied          , FESURFACEPAIRINTERACTION_ID, "facet-to-facet tied"        , 0x0205);
