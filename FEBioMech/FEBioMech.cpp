...
REGISTER_FECORE_CLASS(FEDamageCriterionMPSR                , FEMATERIAL_ID, "DC max principal stretch ratio"    );
REGISTER_FECORE_CLASS(FEDamageCriterionJ                   , FEMATERIAL_ID, "DC volume ratio"                   );
