...
void FEElasticShellDomain::CoBaseVectors0(FEShellElement& el, int n, vec3d g[3])
{
	int i;
...
void FEElasticShellDomain::ContraBaseVectors0(FEShellElement& el, int n, vec3d gcnt[3])
{
	vec3d gcov[3];
...
//-----------------------------------------------------------------------------
double FEElasticShellDomain::invjac0(FEShellElement& el, double Ji[3][3], int n)
{
	vec3d gcov[3];
	CoBaseVectors0(el, n, gcov);
...
double FEElasticShellDomain::detJ0(FEShellElement &el, int n)
{
	vec3d gcov[3];
	CoBaseVectors0(el, n, gcov);
...
//!
void FEElasticShellDomain::FindSSI()
{
