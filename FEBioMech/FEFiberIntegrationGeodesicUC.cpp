...
double FEFiberIntegrationGeodesicUC::m_cth[NSTH];
double FEFiberIntegrationGeodesicUC::m_sth[NSTH];
double FEFiberIntegrationGeodesicUC::m_cph[NSTH];
double FEFiberIntegrationGeodesicUC::m_sph[NSTH];
double FEFiberIntegrationGeodesicUC::m_w[NSTH];
...
//-----------------------------------------------------------------------------
void FEFiberIntegrationGeodesicUC::IntegratedFiberDensity(double& IFD)
{
