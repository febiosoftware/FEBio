...
void FERigidContractileForce::Residual(FEGlobalVector& R)
{
    vector<double> fa(6);
    vector<double> fb(6);
...
//-----------------------------------------------------------------------------
bool FERigidContractileForce::Augment(int naug)
{
    return true;
}
