...
CMenu::CMenu(int w, int h, CWnd* pwnd) : Fl_Menu_Bar(0, 0, w, h), m_pWnd(pwnd)
{
	...
	static Fl_Menu_Item m[] = {
		{"File", 0, 0, 0, FL_SUBMENU },
			...
			{"Save as ..."     , FL_CTRL + 'a' , FLX_MENU_HANDLER(pwnd, CWnd::OnFileSaveAs     )},
			{"Revert"          ,              0, FLX_MENU_HANDLER(pwnd, CWnd::OnFileRevert     ), FL_MENU_DIVIDER},
			{"Close"           , FL_CTRL+FL_F+4, FLX_MENU_HANDLER(pwnd, CWnd::OnFileClose      )},
