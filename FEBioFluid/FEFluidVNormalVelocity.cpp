...
//=============================================================================
BEGIN_FECORE_CLASS(FEFluidVNormalVelocity, FESurfaceLoad)
...
//-----------------------------------------------------------------------------
//! constructor
FEFluidVNormalVelocity::FEFluidVNormalVelocity(FEModel* pfem) : FESurfaceLoad(pfem), m_VC(FE_DOUBLE)
{
    m_velocity = 0.0;
    m_bpar = false;
...
//-----------------------------------------------------------------------------
//! allocate storage
void FEFluidVNormalVelocity::SetSurface(FESurface* ps)
{
...
void FEFluidVNormalVelocity::Residual(const FETimeInfo& tp, FEGlobalVector& R)
{
}

//-----------------------------------------------------------------------------
//! initialize
bool FEFluidVNormalVelocity::Init()
{
...
void FEFluidVNormalVelocity::Activate()
{
    FESurface* ps = &GetSurface();
...
void FEFluidVNormalVelocity::Update()
{
...
bool FEFluidVNormalVelocity::SetParabolicVelocity()
{
