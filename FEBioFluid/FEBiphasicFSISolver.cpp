...
BEGIN_FECORE_CLASS(FEBiphasicFSISolver, FENewtonSolver)
...
//
FEBiphasicFSISolver::FEBiphasicFSISolver(FEModel* pfem) : FENewtonSolver(pfem), m_rigidSolver(pfem), \
m_dofU(pfem), m_dofV(pfem), m_dofSU(pfem), m_dofSV(pfem), m_dofSA(pfem),m_dofR(pfem), m_dofVF(pfem),m_dofAF(pfem),m_dofW(pfem), m_dofAW(pfem)
{
    ...
    int varD = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::DISPLACEMENT), VAR_VEC3);
    dofs.SetDOFName(varD, 0, "x");
    dofs.SetDOFName(varD, 1, "y");
    dofs.SetDOFName(varD, 2, "z");
    
    int varV = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::VELOCITY), VAR_VEC3);
    dofs.SetDOFName(varV, 0, "vx");
    dofs.SetDOFName(varV, 1, "vy");
    dofs.SetDOFName(varV, 2, "vz");
    
    int varQ = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::SHELL_ROTATION), VAR_VEC3);
    dofs.SetDOFName(varQ, 0, "u");
    dofs.SetDOFName(varQ, 1, "v");
    dofs.SetDOFName(varQ, 2, "w");
    
    int varSD = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::SHELL_DISPLACEMENT), VAR_VEC3);
    dofs.SetDOFName(varSD, 0, "sx");
    dofs.SetDOFName(varSD, 1, "sy");
    dofs.SetDOFName(varSD, 2, "sz");
    
    int varQV = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::SHELL_VELOCITY), VAR_VEC3);
    dofs.SetDOFName(varQV, 0, "svx");
    dofs.SetDOFName(varQV, 1, "svy");
    dofs.SetDOFName(varQV, 2, "svz");
    
    int varQA = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::SHELL_ACCELERATION), VAR_VEC3);
    dofs.SetDOFName(varQA, 0, "sax");
    dofs.SetDOFName(varQA, 1, "say");
    dofs.SetDOFName(varQA, 2, "saz");
    
    int varQR = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::RIGID_ROTATION), VAR_VEC3);
    dofs.SetDOFName(varQR, 0, "Ru");
    dofs.SetDOFName(varQR, 1, "Rv");
    dofs.SetDOFName(varQR, 2, "Rw");
    
    int nW = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::RELATIVE_FLUID_VELOCITY), VAR_VEC3);
    dofs.SetDOFName(nW, 0, "wx");
    dofs.SetDOFName(nW, 1, "wy");
    dofs.SetDOFName(nW, 2, "wz");
    
    int nAW = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::RELATIVE_FLUID_ACCELERATION), VAR_VEC3);
    dofs.SetDOFName(nAW, 0, "awx");
    dofs.SetDOFName(nAW, 1, "awy");
    dofs.SetDOFName(nAW, 2, "awz");
    
    int nVF = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::FLUID_VELOCITY), VAR_VEC3);
    dofs.SetDOFName(nVF, 0, "vfx");
    dofs.SetDOFName(nVF, 1, "vfy");
    dofs.SetDOFName(nVF, 2, "vfz");
    
    int nAF = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::FLUID_ACCELERATION), VAR_VEC3);
    dofs.SetDOFName(nAF, 0, "afx");
    dofs.SetDOFName(nAF, 1, "afy");
    dofs.SetDOFName(nAF, 2, "afz");
    
    int nE = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::FLUID_DILATATION), VAR_SCALAR);
    dofs.SetDOFName(nE, 0, "ef");
    
    int nAE = dofs.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::FLUID_DILATATION_TDERIV), VAR_SCALAR);
    ...
    m_dofSV.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::SHELL_VELOCITY));
    m_dofSA.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::SHELL_ACCELERATION));
    ...
    m_dofVF.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::FLUID_VELOCITY));
    m_dofAF.AddVariable(FEBioBiphasicFSI::GetVariableName(FEBioBiphasicFSI::FLUID_ACCELERATION));
...
//-----------------------------------------------------------------------------
FEBiphasicFSISolver::~FEBiphasicFSISolver()
{
...
void FEBiphasicFSISolver:: SolverWarnings()
{
...
bool FEBiphasicFSISolver::InitEquations()
{
...
//-----------------------------------------------------------------------------
void FEBiphasicFSISolver::GetDisplacementData(vector<double> &xi, vector<double> &ui)
{
    FEModel& fem = *GetFEModel();
...
//-----------------------------------------------------------------------------
void FEBiphasicFSISolver::GetVelocityData(vector<double> &vi, vector<double> &ui)
{
    FEModel& fem = *GetFEModel();
...
//-----------------------------------------------------------------------------
void FEBiphasicFSISolver::GetDilatationData(vector<double> &ei, vector<double> &ui)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::Serialize(DumpStream& ar)
{
...
//! accelerations, etc.
void FEBiphasicFSISolver::UpdateKinematics(vector<double>& ui)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::UpdateIncrements(vector<double>& Ui, vector<double>& ui, bool emap)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::Update(vector<double>& ui)
{
    FEModel& fem = *GetFEModel();
...
//-----------------------------------------------------------------------------
//! Update EAS
void FEBiphasicFSISolver::UpdateEAS(vector<double>& ui)
{
    FEModel& fem = *GetFEModel();
...
//-----------------------------------------------------------------------------
//! Update EAS
void FEBiphasicFSISolver::UpdateIncrementsEAS(vector<double>& ui, const bool binc)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::UpdateModel()
{
    FEModel& fem = *GetFEModel();
    FEMesh& mesh = fem.GetMesh();
...
void FEBiphasicFSISolver::UpdateContact()
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::UpdateConstraints()
{
    FEModel& fem = *GetFEModel();
    FETimeInfo& tp = fem.GetTime();
    tp.currentIteration = m_niter;
...
//-----------------------------------------------------------------------------
bool FEBiphasicFSISolver::InitStep(double time)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::PrepStep()
{
    FEModel& fem = *GetFEModel();
...
//-----------------------------------------------------------------------------
bool FEBiphasicFSISolver::Quasin()
{
    FEModel& fem = *GetFEModel();
...
bool FEBiphasicFSISolver::StiffnessMatrix()
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::NonLinearConstraintStiffness(FELinearSystem& LS, const FETimeInfo& tp)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::ContactStiffness(FELinearSystem& LS)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::ContactForces(FEGlobalVector& R)
{
    FEModel& fem = *GetFEModel();
...
bool FEBiphasicFSISolver::Residual(vector<double>& R)
{
    FEModel& fem = *GetFEModel();
...
void FEBiphasicFSISolver::NonLinearConstraintForces(FEGlobalVector& R, const FETimeInfo& tp)
{
    FEModel& fem = *GetFEModel();
    int N = fem.NonlinearConstraints();
    for (int i=0; i<N; ++i)
