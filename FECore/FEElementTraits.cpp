...
void FETri7_::shape_deriv(double* Hr, double* Hs, double r, double s)
{
	...
	Hr[6] = 27.0*r*(1.0 - r - 2.0*s);
	Hs[0] = -3.0 + 4.0*s + 4.0*r + Hr[6]/9.0;
	Hs[1] =  0.0 + Hr[6]/9.0;
	Hs[2] =  4.0*s - 1.0 + Hr[6]/9.0;
	Hs[3] = -4.0*r - 4.0*Hr[6]/9.0;
	Hs[4] =  4.0*r - 4.0*Hr[6]/9.0;
	Hs[5] =  4.0 - 8.0*s - 4.0*r - 4.0*Hr[6]/9.0;
}
...
void FETri7_::shape_deriv2(double* Hrr, double* Hrs, double* Hss, double r, double s)
{
	...
	Hrr[0] =  4.0 + Hrr[6]/9.0; Hrs[0] =  4.0 + Hrr[6]/9.0; Hss[0] =  4.0 + Hss[6]/9.0;
