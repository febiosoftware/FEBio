...
void FEFergusonShellQuadElementTraits::init()
{
    ...
    const double w1 = 5.0 / 9.0;
    const double w2 = 8.0 / 9.0;
    double Fr[4], Fs[4];    // Ferguson basis function
    double Gr[4], Gs[4];    // 1st deriv of Ferguson basis function
    double Sr[4], Ss[4];    // 2nd deriv of Ferguson basis function
    ...
    for (n=0; n<NINT; ++n)
    {
        ...
        shape_deriv2(Sr, gr[n]);
        shape_deriv2(Ss, gs[n]);
