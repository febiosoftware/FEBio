...
//! \todo This is a work in progress. I'd like to call this the BFGSSolver2,
//!       but this name is already in use. This class should handle the common
//!       tasks in all solver classes that use the BFGSSolver2.
class FENewtonSolver2 : public FESolver
{
public:
    //! constructor
    FENewtonSolver2(FEModel* pfem);
...
public:
    ...
    BFGSSolver2	m_bfgs;			//!< BFGS2 solver parameters
