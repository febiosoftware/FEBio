...
inline mat3ds tens5d::contract3rs(tens3drs H)
{
	...
	s(1,1) = d[0]*H.d[0] + 2*d[1]*H.d[1] + 2*d[2]*H.d[2] + d[3]*H.d[3] + 2*d[4]*H.d[4] + d[5]*H.d[5] + d[6]*H.d[6] + 2*d[7]*H.d[7] + 2*d[8]*H.d[8] + d[9]*H.d[9] + 2*d[10]*H.d[10] + d[11]*H.d[11] + d[12]*H.d[12] + 2*d[13]*H.d[13] + 2*d[14]*H.d[14] + d[15]*H.d[15] + 2*d[16]*H.d[16] + d[17]*H.d[17];
	s(1,2) = d[18]*H.d[0] + 2*d[19]*H.d[1] + 2*d[20]*H.d[2] + d[21]*H.d[3] + 2*d[22]*H.d[4] + d[23]*H.d[5] + d[24]*H.d[6] + 2*d[25]*H.d[7] + 2*d[26]*H.d[8] + d[27]*H.d[9] + 2*d[28]*H.d[10] + d[29]*H.d[11] + d[30]*H.d[12] + 2*d[31]*H.d[13] + 2*d[32]*H.d[14] + d[33]*H.d[15] + 2*d[34]*H.d[16] + d[35]*H.d[17];
	s(1,3) = d[36]*H.d[0] + 2*d[37]*H.d[1] + 2*d[38]*H.d[2] + d[39]*H.d[3] + 2*d[40]*H.d[4] + d[41]*H.d[5] + d[42]*H.d[6] + 2*d[43]*H.d[7] + 2*d[44]*H.d[8] + d[45]*H.d[9] + 2*d[46]*H.d[10] + d[47]*H.d[11] + d[48]*H.d[12] + 2*d[49]*H.d[13] + 2*d[50]*H.d[14] + d[51]*H.d[15] + 2*d[52]*H.d[16] + d[53]*H.d[17];
	s(2,2) = d[54]*H.d[0] + 2*d[55]*H.d[1] + 2*d[56]*H.d[2] + d[57]*H.d[3] + 2*d[58]*H.d[4] + d[59]*H.d[5] + d[60]*H.d[6] + 2*d[61]*H.d[7] + 2*d[62]*H.d[8] + d[63]*H.d[9] + 2*d[64]*H.d[10] + d[65]*H.d[11] + d[66]*H.d[12] + 2*d[67]*H.d[13] + 2*d[68]*H.d[14] + d[69]*H.d[15] + 2*d[70]*H.d[16] + d[71]*H.d[17];
	s(2,3) = d[72]*H.d[0] + 2*d[73]*H.d[1] + 2*d[74]*H.d[2] + d[75]*H.d[3] + 2*d[76]*H.d[4] + d[77]*H.d[5] + d[78]*H.d[6] + 2*d[79]*H.d[7] + 2*d[80]*H.d[8] + d[81]*H.d[9] + 2*d[82]*H.d[10] + d[83]*H.d[11] + d[84]*H.d[12] + 2*d[85]*H.d[13] + 2*d[86]*H.d[14] + d[87]*H.d[15] + 2*d[88]*H.d[16] + d[89]*H.d[17];
	s(3,3) = d[90]*H.d[0] + 2*d[91]*H.d[1] + 2*d[92]*H.d[2] + d[93]*H.d[3] + 2*d[94]*H.d[4] + d[95]*H.d[5] + d[96]*H.d[6] + 2*d[97]*H.d[7] + 2*d[98]*H.d[8] + d[99]*H.d[9] + 2*d[100]*H.d[10] + d[101]*H.d[11] + d[102]*H.d[12] + 2*d[103]*H.d[13] + 2*d[104]*H.d[14] + d[105]*H.d[15] + 2*d[106]*H.d[16] + d[107]*H.d[17];
