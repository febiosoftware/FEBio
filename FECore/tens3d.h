...
class tens3ds : public tensor_base<tens3ds, 10>
{
public:
	enum { NNZ = 10 };
...
class tens3drs : public tensor_base<tens3drs, 18>
{
public:
	enum { NNZ = 18 };
...
class tens3dls : public tensor_base<tens3dls, 18>
{
public:
	enum { NNZ = 18 };
...
class tens3d : public tensor_base<tens3d, 27>
{
public:
	enum { NNZ = 27 };
